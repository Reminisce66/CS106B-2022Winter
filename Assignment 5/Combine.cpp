...
Vector<DataPoint> mergeSort(const Vector<DataPoint>& v1, const Vector<DataPoint>& v2) {
...
Vector<DataPoint> combine(const Vector<Vector<DataPoint>>& sequences) {
    ...
    auto leftList = combine(left);
    auto rightList = combine(right);
